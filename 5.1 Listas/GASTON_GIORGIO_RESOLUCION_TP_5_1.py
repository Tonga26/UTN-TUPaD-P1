...
# Esto podria hacerse mas breve de esta forma: lista = [i for i in range(1, 101) if i % 4 == 0]
...
lista_elementos = ["lunes", "martes", "miercoles", "jueves", "viernes"]
...
# La funcion remove, en este ejemplo, remueve el número mayor de todos los elementos de la lista, ya que contiene en su interior, a su vez, la funcion max)
...
dos_primeros_numeros = lista[0:2]

print(dos_primeros_numeros)
